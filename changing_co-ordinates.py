...
# print(f"{latitude_dms[:1]}' ")
# print(f"{latitude_dms[:1]}'' ")
# longitude_dms = (input("What are your latitudinal co-ordinates in DMS (degrees , minutes , seconds)"))

# print( longitude_dms[:1])  
# print(longitude_dms[2]) 
# print(longitude_dms[3])
# print(f"{longitude_dms[:1]}' ")
# print(f"{longitude_dms[:1]}'' ")
#rocket_latitude = (input(f"What are the latitudinal co-ordinates of your launch site in {latitude_dms}"))
