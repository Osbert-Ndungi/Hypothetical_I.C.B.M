...
#exhaust_velocity = 
average_burning_surface_area = (float(input("What is your average burning surface area-This is the area of the cylinder that contains the propellant\n")))
rocket_fuel_type = (int(input("\nWhat type of propellant is being used:\n1.Solid\n2.Liquid\n3.Space-Engine e.g Ion-Thrusters\n")))
...
if rocket_fuel_type == 1:
    ...
    if solid_fuel_type == 1: 
        ammonium_perchlorate_burn_rate = 0.03 #This is an average of between 0.01 to 0.05 m/s
        ammonium_perchlorate_density = 1800 #This is in kg/m3
        ammonium_perchlorate_mfr = ammonium_perchlorate_burn_rate * average_burning_surface_area * ammonium_perchlorate_density #This is the average mass flow rate of Ammonium-perchlorate in kg/s
        print(f"Your ammonium-perchlorate mass flow rate is {ammonium_perchlorate_mfr}kg/s")
    
    if solid_fuel_type == 2:
        potassium_perchlorate_burn_rate =  0.016 #This is an average of between 0.002 to 0.03 m/s   
        potassium_perchlorate_density = 2520 #This is in kg/m3
        potassium_perchlorate_mfr = potassium_perchlorate_burn_rate * average_burning_surface_area* potassium_perchlorate_density
        print(f"Your potassium-perchlorate mass flow rate is {potassium_perchlorate_mfr}kg/s")
    ...
    if solid_fuel_type == 3:
        ...
        zinc_sulfur_mfr = zinc_sulfur_burn_rate * average_burning_surface_area * zinc_sulfur_density
    ...
    if solid_fuel_type == 4:
        ...
        composite_mfr = composite_burn_rate * average_burning_surface_area * composite_density
        print(f"Your composite mass flow rate is {composite_mfr}kg/s")
    
    if solid_fuel_type == 5:
        double_base_burn_rate = 0.015 #This is an average of between 0.005 and 0.025 m/s 
        double_base_density = 1650 #This is an average of between 1600 to 1700 kg/m3
        double_base_mfr = double_base_burn_rate * average_burning_surface_area * double_base_density
    ...
    if solid_fuel_type == 6:
        ...
        black_powder_mfr = black_powder_burn_rate * average_burning_surface_area * black_powder_density
        print(f"Your black powder mass flow rate is {black_powder_mfr}kg/s")

        
elif rocket_fuel_type == 2: 
    liquid_fuel_type = (int(input("What is your liquid fuel type from the list below:\n1.Liquid hydrogen(LH2)\n2.Liquid Oxygen\n3.Hydrogen-Peroxide\n4.Petroleum-fuel\n5.Liquid-Methane\n6.Liquid-BioLPG")))
    if liquid_fuel_type == 1:
        ...
        liquid_hydrogen_mfr = liquid_hydrogen_burn_rate * average_burning_surface_area * liquid_hydrogen_density
        ...
        liquid_oxygen_mfr = liquid_oxygen_burn_rate * average_burning_surface_area * liquid_oxygen_density
        print(f"Your liquid oxygen mass flow rate is {liquid_oxygen_mfr}kg/s")

    elif liquid_fuel_type == 3:
        hydrogen_peroxide_burn_rate = 0.3 #This is an average of between 0.2 to 0.4 m/s
        hydrogen_peroxide_density = 1450 #This is in kg/m3
        hydrogen_peroxide_mfr = hydrogen_peroxide_burn_rate * average_burning_surface_area * hydrogen_peroxide_density
        ...
        petroleum_fuel_mfr = petroleum_fuel_burn_rate * average_burning_surface_area * petroleum_fuel_density
        ...
        liquid_methane_mfr = liquid_methane_burn_rate * average_burning_surface_area * liquid_methane_density
        ...
        liquid_Bio_LPG_mfr = liquid_Bio_LPG_burn_rate * average_burning_surface_area * liquid_Bio_LPG_density
        print(f"Your liquid-BioLPG mass flow rate is {liquid_Bio_LPG_mfr}kg/s")


elif rocket_fuel_type == 3: 
    space_engine_rocket_type = (int(input("What is your Space-Engine rocket type from the list below:\n1.Liquid Hydrogen\n2.Rocket-Grade-Kerosene(RP-1)\n3.Liquid Oxygen\n4.Methane\n5.Hydrazine")))
    ...
    if space_engine_rocket_type == 1:
        ...
        rocket_grade_kerosene_burn_rate = 1.05 #This is an average of between 0.6 to 1.5 m/s
        rocket_grade_kerosene_density = 810 #This is in kg/m3
        rocket_grade_kerosene_mfr = rocket_grade_kerosene_burn_rate * average_burning_surface_area * rocket_grade_kerosene_density
        print(f"Your Rocket-grade kerosene mass flow rate is {rocket_grade_kerosene_mfr}kg/s")
        ...
        hydrazine_mfr = hydrazine_burn_rate * average_burning_surface_area * hydrazine_density
